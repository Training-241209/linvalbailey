...
public class Reimbursement {
   ...
   @Column(name = "userId")
    ...
    public Reimbursement( Integer reimbId, String status){
        this.reimbId = reimbId;
        this.status = status;

    }

    public Reimbursement( Integer reimbId, String status,Integer amount){
        this.reimbId = reimbId;
        this.status = status;
        this.amount= amount;
    ...
    public Reimbursement( Integer reimbId, String status,Integer amount, String description, Integer userId){
        this.reimbId = reimbId;
        this.status = status;
        this.amount= amount;
